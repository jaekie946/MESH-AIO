...
<!-- MESH-AIO:RELEASE:v2.10.5:START -->
## v2.10.5
...
- 버전: v2.10.5. Riot Data Dragon 16.15.1과 패치 고정 16.15 클라이언트 원본 기준의 173챔피언(전용 22, 공용 151) 지원을 그대로 유지합니다.
...
- Version: v2.10.5. 173-champion support (22 hand-tuned, 151 shared-engine) stays on Riot Data Dragon 16.15.1 and the patch-pinned 16.15 client data.
...
- 版本：v2.10.5。继续基于 Riot Data Dragon 16.15.1 与补丁锁定的 16.15 客户端原始数据支持 173 位英雄（22 个专属、151 个共用引擎）。
...
<!-- MESH-AIO:RELEASE:v2.10.5:END -->

<!-- MESH-AIO:RELEASE:v2.10.3:START -->
## v2.10.3
...
- 버전: v2.10.3. Riot Data Dragon 16.15.1과 패치 고정 16.15 클라이언트 원본 기준의 173챔피언(전용 22, 공용 151) 지원을 그대로 유지합니다.
- 갱플랭크 첫 인게임 실측(F12) 피드백을 반영한 수정 릴리즈입니다.
...
- Version: v2.10.3. 173-champion support (22 hand-tuned, 151 shared-engine) stays on Riot Data Dragon 16.15.1 and the patch-pinned 16.15 client data.
- A fix release from Gangplank's first in-game F12 feedback.
...
- 版本：v2.10.3。继续基于 Riot Data Dragon 16.15.1 与补丁锁定的 16.15 客户端原始数据支持 173 位英雄（22 个专属、151 个共用引擎）。
- 这是根据普朗克首次游戏内 F12 实测反馈的修复版本。
